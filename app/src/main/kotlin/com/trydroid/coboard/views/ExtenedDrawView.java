...
public class ExtenedDrawView extends FrameLayout implements View.OnTouchListener {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(
            attrs, com.byox.drawview.R.styleable.DrawView, 0, 0);
        try {
            mDrawColor = typedArray.getColor(com.byox.drawview.R.styleable.DrawView_dv_draw_color, Color.BLACK);
            mDrawWidth = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_width, 3);
            mDrawAlpha = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_alpha, 255);
            mAntiAlias = typedArray.getBoolean(com.byox.drawview.R.styleable.DrawView_dv_draw_anti_alias, true);
            mDither = typedArray.getBoolean(com.byox.drawview.R.styleable.DrawView_dv_draw_dither, true);
            int paintStyle = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_style, 2);
            if (paintStyle == 0)
            ...
            int cap = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_corners, 2);
            if (cap == 0)
            ...
            int typeface = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_font_family, 0);
            if (typeface == 0)
            ...
            mFontSize = typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_font_size, 12);
            ...
            mDrawingTool = DrawingTool.values()[typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_tool, 0)];
            mDrawingMode = DrawingMode.values()[typedArray.getInteger(com.byox.drawview.R.styleable.DrawView_dv_draw_mode, 0)];
        } finally {
            typedArray.recycle();
        }
    }
